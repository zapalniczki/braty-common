...
declare const label: import("zod").ZodObject<import("zod").extendShape<import("zod").extendShape<{
    ...
    icons: ("HEART" | "BOAT" | "PKiN" | "HEART_2022" | "DOUBLE_HEART" | "ARROW_BELOW" | "CHRISTMAS_TREE_STRIPES" | "CHRISTMAS_TREE_STAR" | "CHRISTMAS_TREE_PATTERN" | "BALLOONS" | "FIREWORKS" | "SANTA_FACE" | "CHRISTMAS_TREE" | "SHIP" | "WARSAW_MERMAID")[];
    label_pl: string;
    label_en: string;
    created_at: string;
    id: string;
